...
//		ViewHolder holder;
//		if(convertView == null){ 
			convertView = View.inflate(context, R.layout.items_list_contacts_center, null);
			
			if(position == 2){
				convertView = View.inflate(context, R.layout.items_list_contacts_center_text, null);
			}
